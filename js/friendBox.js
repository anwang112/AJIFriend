        ...
        xhr.onload = function () {
            ...
            if (xhr.responseText == "null") { //失敗狀態
                ...
                if (num == 0) {
                    ...
                    let ddd = 0;
                    getfriendGo = () => {
                        if (ddd == friendInfo.length - 1) {
                            clearInterval(getfriendId);
                        }
                        ooxxGetHead($id(`headImg_div${friend_infoArr[ddd][0]}`), {
                            animal: friend_infoArr[ddd][2],
                            color: friend_infoArr[ddd][4],
                            eyes: friend_infoArr[ddd][3],
                        });
                        ddd++;
                    }
                    getfriendId = setInterval(getfriendGo, 100);
                }
            };
        }
