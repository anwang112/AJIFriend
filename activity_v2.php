        ...
        <div id="wrap1" class="wrap1">
            <div class="act_section01">
                ...
                <div class="act_mainbox">
                    <div class="imgBox">
                        <img id="imgBoxImg" src="images/activity/act_number01.svg" alt="">
                    </div>
                    <div class="btnbox">
                ...
                <div id="lightbox_act" class="lightbox_act">
                    <div id="lightbox_act_info" class="lightbox_act_info">
                        ...
                        <p>活動說明: Lorem ipsum dolor sit amet consectet`ur adipisicing elit. Aliquam, perspiciatis? Officia amet obcaecati voluptate</p>
                        <div class="spanbox">
                            <span>人數：{{}}</span>
                            <span>地點：{{}}</span>  
                            <span>獎勵：{{}}</span> 
                        </div>
                        <button id="btn_Actjoin01" class="btn_R">立即參加</button> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrap2">
            <div class="act_section02">
                ...
                <div id="partA" class="partA">
                    <div class="act_officialBanner">
                        <img src="images/activity/act_number01B.svg" alt="活動banner">
                        <div class="act_info">
                            <h2>攀岩聯聯看</h2>
                            <?php $activity->fetch(PDO::FETCH_ASSOC)?>
                                <span>時間：<?php echo  substr($act_begin,0,10) ; ?>至<?php echo substr($act_end,0,10);?></span>
                                <span>地點：<?php echo $actLoc; ?></span>
                                <span>人數:</span>
                                <span>獎勵:</span>
                                <p>活動資訊：<?php echo $actIntro ?> </p>
                                <button id="btn_actJoin" class="btn_R">報名</button>
                            <!-- <button id="btn_actCheck" class="btn_R">查看詳情</button> -->
                        </div>
                    </div>
                    <div id="act_memberHold" class="act_memberHold">
                        <div class="act_memberHold_box act_memberHold_box1">
                            <img src="images/activity/act_number02B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                            <?php $activity->fetch(PDO::FETCH_ASSOC)?>
                        ...
                        <div class="act_memberHold_box act_memberHold_box2">
                            <img src="images/activity/act_number02B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                        ...
                        <div class="act_memberHold_box act_memberHold_box3">
                            <img src="images/activity/act_number02B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                        ...
                        <div class="act_memberHold_box act_memberHold_box4">
                            <img src="images/activity/act_number03B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                            <?php $activity->fetch(PDO::FETCH_ASSOC)?>
                        ...
                        <div class="act_memberHold_box act_memberHold_box5">
                            <img src="images/activity/act_number03B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                        ...
                        <div class="act_memberHold_box act_memberHold_box6">
                            <img src="images/activity/act_number03B.svg" alt="">
                            <div class="act_memberHold_join">
                                <button class="btn_ActJoin btn_R">報名</button>
                            </div>
                        ...
                        <div class="act_tab_pages">
                            <span>1</span><span>2</span><span>3</span>
                        </div>                  
                    </div>
                </div>
                <div id="partB" class="partB">
                    <div class="act_memberHold_B">
                        <div class="act_myActs">
                            <h3>我的揪團</h3>
                            <div class="act_memberCheckBox">
                                <img src="images/activity/act_number01B.svg" alt="">
                                <div class="act_MCInfo">
                                    <h4>攀岩聯聯看</h4>
                                    <div id="myMessagebox" class="messagebox"></div>
                                    <!-- <div class="headBox" id="theUser"></div> -->
                                    <input id="myMessagebox_input" class="input_R" type="text" placeholder="回覆留言">
                                </div>    
                            </div>
                        </div>
                        <div class="act_joins">
                            ...
                            <div class="act_memberCheckBox">
                                ...
                                <div class="act_MCInfo">
                                    <h4>攀岩聯聯看</h4>
                                    <div id="JoinMessagebox" class="messagebox"></div>
                                    <input id="JoinMessagebox_input" class="input_R" type="text" placeholder="回覆留言">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="lightbox_holdact" class="lightbox_holdact">
                <div id="lightbox_holdact_info" class="lightbox_holdact_info">
                    ...
                    <h2>舉辦活動</h2>
                        <label for="">Step1_上傳圖片<br>
                            
                        </label>
                        <label for="">Step2_填寫活動介紹<br>
                             <input type="file" name="act_holdActFile" >
                            <input type="text" class="input_R" name="actTitle" placeholder="活動名稱">
                            <input type="text" class="input_R" name="actIntro" placeholder="活動介紹">
                    ...
                    <div class="act_holdActFileBox">--活動圖片--</div>
                </div>
            </div>
        </div>
    <script type="text/javascript">
