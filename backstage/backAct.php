    ...
    <table id="maintable" class="table table-hover">
        <thead>
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input id="act_search_txt" type="text" class="form-control" placeholder="活動編號" aria-label="Recipient's username"
        ...
        <tbody id="clearTarget" class="dddd">
            ...
            <tr>
                ...
                <td><?php echo $actTitle;?></td>
                <td><?php echo $actLoc;?></td>
                <td>
                    <img src="../images/<?php echo $actImg;?>" style="width:100px; height:150px;" alt="活動圖片">
                </td>
                <td>
                     <?php echo  substr($act_begin,0,10) ; ?><br>至<br><?php echo substr($act_end,0,10);?>
                </td>
            </tr>
             <?php } ?>
        </tbody>
