        ...
        <div id="lightbox_holdact" class="lightbox_holdact">
            <div id="lightbox_holdact_info" class="lightbox_holdact_info">
                ...
                <h2>增加商品</h2>
                    ...
                    <label for="">魅力值<?php echo '&nbsp&nbsp&nbsp&nbsp';?><input type="number" class="input_R" name="proMJ_ins" placeholder="請輸入1到1000"  min="0" max="1000"></label>
                    ...
                    function initss(){
                        $id("act_holdActFile").onchange = function(e){
                            ...
                            reader.onload = function(){
                                ...
                                $id("act_holdActFileBox").style.cssText = `padding-bottom: 0%;`;
