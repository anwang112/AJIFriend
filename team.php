...
<body>
    ...
    <div class="bgWrap">
        ...
        <div class="teamMember">
            ...
            <img src="images/chair@3x.png" alt="">
            <img src="images/table_1@3x.png" class="table">
            ...
            <div class="member">
                ...
                <div class="mWrap">
                    <div class="memInfo">
                        ...
                        <div class="infoItem">
                            ...
                            <div class="infoRight">
                                <button class="btn" id="showInfo2">查看個人頁面</button>
                                <a href="http://140.115.236.72/demo-personal/CD105/web/I1800059/" class="btn">個人網站作品</a>
                            </div>
                        </div>
                    </div>
                    <div id="m2" class="memRole"></div>
                </div>
                <div class="mWrap">
                    <div class="memInfo">
                        <p class="infoTitle"><span class="name">王偉安 </span><span>(小組長)</span></p>
                ...
                <div class="mWrap">
                    ...
                    <div id="m4" class="memRole"></div>
                </div>
                <div class="mWrap">
                    <div class="memInfo">
                        <p class="infoTitle"><span class="name">羅介庸 </span><span>(動畫高手)</span></p>
                        <span class="email">4a390141@stust.edu.tw</span>
                        <div class="infoItem">
                            <div class="infoLeft">
                                <p>
                                    首頁切版<br>
                ...
                <div class="mWrap">
                    <div class="memInfo">
                        ...
                        <div class="infoItem">
                            ...
                            <div class="infoRight">
                                <button class="btn" id="showInfo6">查看個人頁面</button>
                                <a href="#" class="btn">個人網站作品</a>
                            </div>
                        </div>
                    </div>
                    <div id="m6" class="memRole"></div>
                </div>
            </div>
        </div>
